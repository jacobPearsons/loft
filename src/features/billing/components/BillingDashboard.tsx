 ...
 * Purpose: Main UI component for displaying billing information and plans
 * Follows docs pattern: Components handle UI only, no business logic
 */
...
interface BillingDashboardProps {
  // Optional: Allow parent to control plan selection
...
/**
 * Plan Card Component
 * Displays individual pricing plan
 */
const PlanCard = ({
  plan,
  currentPlanId,
