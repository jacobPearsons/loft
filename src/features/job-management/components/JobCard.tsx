 ...
 * Job Card Component
 * 
 * Card for displaying individual job postings.
 * Follows frontend-lifecycle: single responsibility, reusable.
 */
...
import { formatSalaryRange, JOB_TYPE_LABELS, WORK_MODE_LABELS, EXPERIENCE_LEVEL_LABELS, JOB_STATUS_LABELS } from '../services/jobService';
