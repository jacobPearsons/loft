...
import { ArrowLeft, Users, Mail, Briefcase, Star, Loader2, AlertCircle, CheckCircle, XCircle } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-5xl mx-auto">
        <Link href="/employer/dashboard" className="inline-flex items-center text-muted-foreground hover:text-foreground transition-colors mb-6">
