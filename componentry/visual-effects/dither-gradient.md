...
```bash
npx componentry@latest add dither-gradient
```
...
|------|------|---------|-------------|
| `colorFrom` | `string` | `"#6366f1"` | Start color of the gradient. |
| `colorMid` | `string` | `"#8b5cf6"` | Middle color of the gradient. |
| `colorTo` | `string` | `"#ec4899"` | End color of the gradient. |
| `intensity` | `number` | `0.15` | Dithering intensity from 0 to 1. |
...
_Component from [Componentry](https://componentry.fun/docs/components/dither-gradient)_
