...
```bash
npx componentry@latest add closing-plasma
```
...
| `interactive` | `boolean` | `true` | Enables pointer interaction and drift response. |
...
| `children` | `ReactNode` | - | Optional overlay content rendered above the plasma layer. |
| `className` | `string` | - | Additional CSS classes for the root container. |

---

_Component from [Componentry](https://componentry.fun/docs/components/closing-plasma)_
