...
```bash
npx componentry@latest add dither-prism-hero
```
...
|------|------|---------|-------------|
| `title1` | `string` | - | First line of the main metallic headline. |
| `title2` | `string` | - | Second line of the main metallic headline. |
| `color1` | `string` | `"#0f0f23"` | Primary color (deep/dark) for the gradient base. |
| `color2` | `string` | `"#6366f1"` | Secondary color (mid-tone) for gradient transitions. |
| `color3` | `string` | `"#ec4899"` | Tertiary color (bright/accent) for gradient highlights. |
| `speed` | `number` | `1` | Animation speed multiplier for all shader effects. |
| `ditherIntensity` | `number` | `0.15` | Intensity of the dithering effect (0-1). Higher values create a more pronounced retro/grainy look. |
| `prismIntensity` | `number` | `0.5` | Intensity of the prismatic rainbow refraction (0-1). |
| `showParticles` | `boolean` | `true` | Whether to show floating particles layer. |
| `particleCount` | `number` | `50` | Number of floating particles (performance consideration). |
| `particleColor` | `string` | `"#ffffff"` | Color of the floating particles. |
| `children` | `ReactNode` | - | Custom content to render on top of the background (e.g., buttons, forms). |
| `className` | `string` | - | Additional CSS classes for the container. |

---

_Component from [Componentry](https://componentry.fun/docs/components/dither-prism-hero)_
