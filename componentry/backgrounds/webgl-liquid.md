...
| `delayMs` | `number` | `0` | Delay before animation/reveal begins, in milliseconds. |
| `revealDuration` | `number` | `1.2` | Duration of the reveal wipe in seconds. |
| `children` | `ReactNode` | - | Custom content rendered above the liquid background. |
| `className` | `string` | - | Additional CSS classes for the root container. |

---

_Component from [Componentry](https://componentry.fun/docs/components/webgl-liquid)_
