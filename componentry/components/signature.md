...
```bash
npx componentry@latest add signature
```

**Dependencies:** framer-motion opentype.js
...
|------|------|---------|-------------|
| `text` | `string` | - | Text to generate signature for. |
| `color` | `string` | `"currentColor"` | Color of the signature path. |
| `fontSize` | `number` | `32` | Font size of the signature. |
| `duration` | `number` | `1.5` | Animation duration in seconds. |
| `delay` | `number` | `0` | Delay before animation starts in seconds. |
| `className` | `string` | - | Additional CSS classes. |
| `inView` | `boolean` | `false` | Only animate when in view. |
| `once` | `boolean` | `true` | Only animate once. |

---

_Component from [Componentry](https://componentry.fun/docs/components/signature)_
