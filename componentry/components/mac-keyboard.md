...
```bash
npx componentry@latest add mac-keyboard
```
...
```tsx
import { MacKeyboard, MacKey } from "@/components/ui/mac-keyboard";
...
_Component from [Componentry](https://componentry.fun/docs/components/mac-keyboard)_
